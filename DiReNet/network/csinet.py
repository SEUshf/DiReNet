...
class CsiNet32(nn.Module):
    def __init__(self,reduction=4):
        super(CsiNet32, self).__init__()
...
class CsiNet2(nn.Module):
    def __init__(self,reduction=4):
        super(CsiNet2, self).__init__()
        # total_size, in_channel, w, h = 1024, 2, 16, 32
        total_size, in_channel, w, h = 1024, 2, 16, 12
        dim_out = total_size // reduction
