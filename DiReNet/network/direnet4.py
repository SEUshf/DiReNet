...
class IABlock(nn.Module):
    ...
    def forward(self, x):
        ...
        out_mut = out_add*self.conv1x1_out(x_id)
        out = out_mut
        return out
...
class IABlock2(nn.Module):
    def __init__(self, dim=2):
        ...
        self.conv1x1_clone = nn.Sequential(OrderedDict([
    ...
    def forward(self, x):
        x_clone = self.identity(x)
        x_id = self.conv1x1_clone(x)
        out0 = self.one(x_id)
        out1 = self.path1(out0)
        out2 = self.path2(out0)
        out3 = self.path3(out0)
        out_add = self.conv1x1_in(out0+out1+out2+out3)
        out_mut = out_add*self.conv1x1_out(x_id)
        out = self.relu(out_mut+x_clone)
        return out


class DiReNet_none(nn.Module):
    def __init__(self):
        super(DiReNet_none, self).__init__()
       
    def forward(self, data):
        n, c, h, w = data.detach().size()

        xy = (torch.abs(data[:,:, 0:16,:])+torch.abs(data[:,:,16:32,:]))/2
        # x = torch.angle(data[:,:, 0:16,:])
        # y = torch.angle(data[:,:,16:32,:])
        x = torch.sign(data[:,:, 0:16,:])
        y = torch.sign(data[:,:,16:32,:])
        return xy,x,y
...
class DiReNetD1(nn.Module):
    def __init__(self):
        super(DiReNetD1, self).__init__()
    ...
    def forward(self, x_c, y_c):
        ...
        x_hat = self.decoder_feature_x1(x_c)
        y_hat = self.decoder_feature_y1(y_c)
...
class DiReNetD7(nn.Module):
    def __init__(self):
        super(DiReNetD7, self).__init__()
    ...
    def forward(self,x_c,y_c):
        ...
        x_hat = self.decoder_feature_x1(x_c)+self.decoder_feature_x2(x_c)+self.decoder_feature_x3(x_c)+self.decoder_feature_x4(x_c)+self.decoder_feature_x5(x_c)+self.decoder_feature_x6(x_c)+self.decoder_feature_x7(x_c)
        y_hat = self.decoder_feature_y1(y_c)+self.decoder_feature_y2(y_c)+self.decoder_feature_y3(y_c)+self.decoder_feature_y4(y_c)+self.decoder_feature_y5(y_c)+self.decoder_feature_y6(x_c)+self.decoder_feature_y7(x_c)
        x_hat = self.sigmoid_x(x_hat)
        y_hat = self.sigmoid_y(y_hat)

        return x_hat,y_hat

class DiReNetD9(nn.Module):
    def __init__(self):
        super(DiReNetD9, self).__init__()
    ...
    def forward(self,x_c,y_c):
        ...
        x_hat = self.decoder_feature_x1(x_c)+self.decoder_feature_x2(x_c)+self.decoder_feature_x3(x_c)+self.decoder_feature_x4(x_c)+self.decoder_feature_x5(x_c)+self.decoder_feature_x6(x_c)+self.decoder_feature_x7(x_c)+self.decoder_feature_x8(x_c)+self.decoder_feature_x9(x_c)
        y_hat = self.decoder_feature_y1(y_c)+self.decoder_feature_y2(y_c)+self.decoder_feature_y3(y_c)+self.decoder_feature_y4(y_c)+self.decoder_feature_y5(y_c)+self.decoder_feature_y6(x_c)+self.decoder_feature_y7(x_c)+self.decoder_feature_y8(x_c)+self.decoder_feature_y9(x_c)
        x_hat = self.sigmoid_x(x_hat)
        y_hat = self.sigmoid_y(y_hat)
...
class DiReNetD5_d1(nn.Module):
    def __init__(self):
        super(DiReNetD5_d1, self).__init__()
...
class DiReNetD5_d2(nn.Module):
    def __init__(self):
        super(DiReNetD5_d2, self).__init__()
...
class DiReNetD5_d3(nn.Module):
    def __init__(self):
        super(DiReNetD5_d3, self).__init__()
...
class DiReNetD5_d4(nn.Module):
    def __init__(self):
        super(DiReNetD5_d4, self).__init__()
...
class DiReNetD5_d5(nn.Module):
    def __init__(self):
        super(DiReNetD5_d5, self).__init__()
